...
for i in range(number_shooting_points[2] + 1):
    ...
    # sum moments = 0
    jm0 = (Meta1[1]*fm1[1] + Meta5[1]*fm5[2] - Meta5[2]*fm5[1]) - M_CoP[2][0, i]
    jm1 = (Meta1[2]*fm1[0] - Meta1[0]*fm1[1] + Meta5[2]*fm5[0] - Meta5[0]*fm5[2]) - M_CoP[2][1, i]
    jm2 = (-Meta1[1]*fm1[0] + Meta5[0]*fm5[1] - Meta5[1]*fm5[0]) - M_CoP[2][2, i]
...
Fx_meta1 = np.array(F1[0::2]).squeeze()
Fz_meta1 = np.array(F1[1::2]).squeeze()
Fx_meta5 = np.array(F5[0::3]).squeeze()
Fy_meta5 = np.array(F5[1::3]).squeeze()
Fz_meta5 = np.array(F5[2::3]).squeeze()
...
for i in range(number_shooting_points[1] + 1):
    ...
    mx[i] = Meta1[1]*Fz_meta1[i] + Meta5[1]*Fz_meta5[i] - Meta5[2]*Fy_meta5[i]
    my[i] = Meta1[2]*Fx_meta1[i] - Meta1[0]*Fz_meta1[i] + Meta5[2]*Fx_meta5[i] - Meta5[0]*Fz_meta5[i]
    mz[i] = -Meta1[1]*Fx_meta1[i] + Meta5[0]*Fy_meta5[i] - Meta5[1]*Fx_meta5[i]
