...
class initial_guess:
    @staticmethod
    def set_initial_guess(model, x_init, u_init, position_high, position_low, nb_shooting):
    ...
    @staticmethod
    def set_initial_guess_from_previous_solution(model, x_init, u_init, save_path, nb_shooting):
        init_x = np.zeros((model.nbQ() + model.nbQdot(), nb_shooting + 1))
