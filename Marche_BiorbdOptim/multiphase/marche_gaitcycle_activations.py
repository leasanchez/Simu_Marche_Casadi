...
if __name__ == "__main__":
    ...
    activation_ref_stance = generate_activation(
        biorbd_model=biorbd_model[0],
        final_time=phase_time[0],
        nb_shooting=number_shooting_points[0],
        emg_ref=excitation_ref_stance,
    )
