#include "marche_Florent_markers_stance.h"
...
const char* libmarche_Florent_markers_stance_name(void){
    return "libmarche_Florent_markers_stance";
}

int libmarche_Florent_markers_stance(const casadi_real** arg, double** res, casadi_int*, casadi_real*, void*){
