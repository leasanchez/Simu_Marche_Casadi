#include "muscular_joint_torque_stance.h"
...
const char* libmuscular_joint_torque_stance_name(void){
    return "libmuscular_joint_torque_stance";
}

int libmuscular_joint_torque_stance(const casadi_real** arg, double** res, casadi_int*, casadi_real*, void*){
