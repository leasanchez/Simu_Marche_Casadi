#include "time_Derivative_Activation.h"
...
const char* libtime_Derivative_Activation_name(void){
    return "libtime_Derivative_Activation";
}

int libtime_Derivative_Activation(const casadi_real** arg, double** res, casadi_int*, casadi_real*, void*){
