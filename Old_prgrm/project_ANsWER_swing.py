...
torque = u[params.nbMus:]                                    # joint torque
...
[GRF_real_swing, params.T, params.T_stance, params.T_swing] = LoadData.load_data_GRF(params, 'swing')
...
for k in range(params.nbNoeuds_swing):
    ...
    # OBJECTIVE FUNCTION
    Jm += Fcn_Objective.fcn_objective_markers(params.wMa, params.wMt, Xk[: params.nbQ], M_real_swing[:, :, k], 'swing')
...
u0[params.nbMus:]     = np.zeros((params.nbQ, params.nbNoeuds_swing))

# STATE
X0 = np.zeros((params.nbX, (params.nbNoeuds_swing + 1)))
X0[:params.nbQ, :] = load_initialguess_q(params, 'swing')
